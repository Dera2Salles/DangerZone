...
import { Bold, Italic, Link as LinkIcon, Underline as UnderlineIcon, Eraser } from 'lucide-react';
...
export function EditorMenus({ editor, onAddLink, onClearFormatting }: EditorMenusProps) {
  return (
    <>
      <FloatingMenu
        editor={editor}
